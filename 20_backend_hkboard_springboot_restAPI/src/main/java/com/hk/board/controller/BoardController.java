...
public class BoardController {
   ...
   //글 목록 요청
//   @ResponseBody: @RestController를 정의하면 작성할 필요가 없음
//   @CrossOrigin(origins = "http://localhost:8086")
   @GetMapping("/boardlist")
   public Map<String, List<HkDto>> boardList() {
      System.out.println("글목록 요청");
      //글 목록 데이터 list객체를 Map에 저장한다. --> json{"list":list}
      //--> json : {"list":[dto,dto,dto, ...]} 서버쪽에서 전달할 때 형태
   ...
   //글추가하기: 전달 파라미터 id,title,content
   @PostMapping("/insert")
