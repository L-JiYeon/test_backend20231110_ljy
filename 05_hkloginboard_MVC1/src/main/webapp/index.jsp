...
<script type="text/javascript">
	...
	function userIdCookie(){
		...
		//화면에 입력된 ID값 가져오기
		var id=document.forms[0].id.value;		//forms속성 이용
//			   document.getElementsByName("id")[0].value;   //dom탐색메서드 이용
...
<form action="BoardController.jsp" method="post" onsubmit="return userIdCookie()">
