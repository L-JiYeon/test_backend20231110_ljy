...
<%@page import="com.hk.prac.daos.UserDao"%>
...
<body>
	...
	//  	  session.removeAttribute("ldto");	//ldto라는 이름으로 저장된 객체 삭제
	...
	//session에서 ID값을 가져올 경우	:	session에 저장되어 있어서 어디에서든 가져올 수 있다
	...
	} else if (command.equals("delUser")) { //회원 탈퇴하기
	String id = request.getParameter("id");
	...
	} else if (command.equals("getUserList")) { //회원목록 조회 등급 수정하기 위해서
